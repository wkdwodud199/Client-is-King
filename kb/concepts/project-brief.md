...
**하드캡**: 가게 1단계(구멍가게), 장르 3종+제네럴리스트, 이벤트 4종, 아트는 CC0/OFL 플레이스홀더 + 오너 승인 AI 생성 아트(task-116 계약 내, provenance 기록 필수) — 유료 외주·스톡 구매는 금지.
...
| task-116 | NYC 코리아타운 아트 오버홀 — 승인 콘셉트 런타임 적용 | M4 (데모 후) | claude-fable-5 | high |
...
**로드맵 v4 (2026-07-12)**: 오너가 Codex Visual North Star(현대 뉴욕 코리아타운 푸드트럭)를 최종 아트 방향으로 승인, NYC 오버홀을 task-116으로 승격.
