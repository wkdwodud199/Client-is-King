...
| 파일 | 라벨 | 규격 | 크기 | 원본 (Codex 캐시 exec-id) |
|------|------|------|------|---------------------------|
| `visual-north-star.png` | Visual North Star (합성 시트) | 1672×941 RGB | 1,976,738 B | `exec-0a6fe4ec-aefb-4c53-ad4d-24d1a6db13d1` |
| `protagonist.png` | 주인공 (턴어라운드·표정·액션) | 1536×1024 RGB | 1,963,120 B | `exec-0789662e-a39a-47e2-8ff3-9cbf98b0d08b` |
| `customers.png` | 손님 4종 (걷기·카운터·표정) | 1672×941 RGB | 1,855,895 B | `exec-7ee53b4a-55b0-4705-a183-54c813c33cc5` |
| `food.png` | 음식 6종 (+소형) | 1536×1024 RGB | 1,930,775 B | `exec-1b1439ea-a436-4240-b7d5-b398f13fa618` |
| `ui-icons.png` | UI 아이콘 (음식+시스템) | 1672×941 RGB | 1,438,672 B | `exec-0c7a5160-1faa-4c42-af4e-da0fe72f2e36` |
| `foodtruck-environment.png` | 푸드트럭 환경 (씬+타일셋) | 1672×941 RGB | 1,853,461 B | `exec-09ecc2a0-66aa-4f6b-acf1-7e5f8fe7a72a` |
